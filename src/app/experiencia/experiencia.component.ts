  ...
  items = [
    {
      ...
      'acordeon': [
        ...
        },
        {
          ...
          'texto': 'Los motivos por los que decidí finalizar con mis labores aquí, fue que en mi búsqueda de empezar a desarrollarme como científico de datos, pese a haber obtenido una posición en la empresa, el cambio de área se vio finalizado debido a situaciones internas que afectaron de manera grave a la compañía, por lo que decidí buscar nuevas oportunidades de crecimiento en otras empresas.',
        },
      ]
    },
    {
      ...
      'acordeon': [
        ...
        {
          'titulo': 'Causa de desvinculación',
          'texto': 'El motivo por el que decidí pausar con esta actividad, al menos por la parte del manejo de fondos a terceros, fue que encontré el área de ciencia de datos, en el cual si lograba desarrollarme podría en un futuro encontrar de combinar las finanzas con la tecnología, por lo que decidí enfocarme en esta nueva área de oportunidad, pero de igual manera sigo invirtiendo de manera personal en la bolsa de valores.',
        },
      ]
    },
    {
      ...
      'acordeon': [
        {
          'titulo': 'Fortalezas que obtuve de esta experiencia',
          'texto': 'La mayor fortaleza que logré de aquí, fue el de obtener el hábito de la lectura, el cual tuve la suerte de desarrollar gracias a la cantidad de libros que tuve que leer para el desarrollo del material didáctico, de igual manera mi capacidad de organización se vio incrementada al tener que cumplir con los tiempos de entrega de los materiales al ser un trabajo home office.',
        },
        {
          'titulo': 'Causa de desvinculación',
          'texto': 'La razón por la que finalicé con mis labores fue que me encontraba bajo contrato temporal, por lo que al finalizar el periodo, la universidad aún se encontraba en desarrollo por lo que no se me pudo ofrecer un puesto fijo, así que decidí buscar nuevas oportunidades.',
        },
      ]
    },
    {
      ...
      'acordeon': [
        {
          'titulo': 'Fortalezas que obtuve de esta experiencia',
          'texto': 'Las dos mayores fortalezas que obtuve de aquí, fueron en primer lugar el experimentar el manejo de una cartera de clientes, crear estrategias de venta para lograr que se pudieran ofrecer los créditos a las pymes, y en segundo lugar el desarrollo de la página web, ya que fue mi primer acercamiento al desarrollo web, lo cual me abrió las puertas a la programación.',
        },
        {
          'titulo': 'Causa de desvinculación',
          'texto': 'El motivo por el que finalicé los labores fue que debido a la pandemia, la empresa se vio en la necesidad de cesar operaciones debido a una fuerte inversión que se hizo antes de la cuarentena.',
        },
      ]
    },
    {
      ...
      'acordeon': [
        {
          'titulo': 'Fortalezas que obtuve de esta experiencia',
          'texto': 'La mayor fortaleza que obtuve de trabajar en el área de RRHH, fue el de desarrollar la empatía, ya que al tener que tratar con las necesidades de los colaboradores, me vi en la necesidad de ponerme en su lugar para poder ofrecerles la mejor solución a sus problemas.',
        },
        {
          'titulo': 'Causa de desvinculación',
